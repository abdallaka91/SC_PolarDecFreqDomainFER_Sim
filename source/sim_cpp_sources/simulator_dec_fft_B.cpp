...
int main(int argc, char *argv[])
{
    ...
    EncodeChanBPSK_BinCCSK(gen, dec_param, table, EbN0, CCSK_rotated_codes, L[0], KSYMB, bin_mod_dict);
    ...
    time_base += std::chrono::duration_cast<std::chrono::microseconds>(m_stop - m_start).count();
