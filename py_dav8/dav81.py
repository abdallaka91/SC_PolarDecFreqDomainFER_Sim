...
snr_values = np.arange(-13.5, -12, 0.5)
snr_values = np.append(snr_values, -12.25)
...
subprocess.run(
    f"cmake   -DCMAKE_CXX_COMPILER=/lab/home/labsticc/abdallah/gcc-install/bin/g++   -DCMAKE_BUILD_TYPE=Release   -DFFTW3_INCLUDE_DIR=$HOME/fftw/include   -DFFTW3_LIBRARY=$HOME/fftw/lib/libfftw3.so   -S . -B {build_dir}",
    shell=True,
    check=True,
)
