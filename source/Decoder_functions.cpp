                                ...
                                vector<vector<uint16_t>> &Bt1)
{
    ...
    {
        b_gf.assign(theta_1.intrinsic_GF.begin(), theta_1.intrinsic_GF.begin() + dec_param.nL);
        b.assign(theta_1.intrinsic_LLR.begin(), theta_1.intrinsic_LLR.begin() + dec_param.nL);
        a_gf.assign(phi_1_p.intrinsic_GF.begin(), phi_1_p.intrinsic_GF.begin() + dec_param.nH);
        a.assign(phi_1_p.intrinsic_LLR.begin(), phi_1_p.intrinsic_LLR.begin() + dec_param.nH);
    }
...

{
    ...
    if (rel_theta)
    {
        a_gf.assign(theta_1.intrinsic_GF.begin(), theta_1.intrinsic_GF.begin() + nH);
        a.assign(theta_1.intrinsic_LLR.begin(), theta_1.intrinsic_LLR.begin() + nH);
        b_gf.assign(phi_1_p.intrinsic_GF.begin(), phi_1_p.intrinsic_GF.begin() + nL);
        b.assign(phi_1_p.intrinsic_LLR.begin(), phi_1_p.intrinsic_LLR.begin() + nL);
    }
    else
    {
        b_gf.assign(theta_1.intrinsic_GF.begin(), theta_1.intrinsic_GF.begin() + nL);
        b.assign(theta_1.intrinsic_LLR.begin(), theta_1.intrinsic_LLR.begin() + nL);
        a_gf.assign(phi_1_p.intrinsic_GF.begin(), phi_1_p.intrinsic_GF.begin() + nH);
        a.assign(phi_1_p.intrinsic_LLR.begin(), phi_1_p.intrinsic_LLR.begin() + nH);
    }
    ...
    theta.intrinsic_LLR.assign(dec_param.q, temp_llr[temp_GF[nm - 1]] + dec_param.offset);
    for (int i = 0; i < nm; i++)
    {
        theta.intrinsic_GF[i] = temp_GF[i];
        theta.intrinsic_LLR[i] = temp_llr[temp_GF[i]];
    }
    for (int i = nm; i < dec_param.q; i++)
        theta.intrinsic_GF[i] = temp_GF[i];
}
